...
def test_new_users(user, expected_status, expected_body):
    ...
    if expected_status == 409:
        user1 = {"username": "user1", "password": "UserUser1!", "email": "user1@gmail.com"}
        response_duplicate = requests.post(url=BASE_URL, json=user1)
    ...
    # Limpa a conta do DB se deu certo criar
